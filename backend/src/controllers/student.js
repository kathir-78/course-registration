...
const registereElectiveCourse = async (req, res) => {
    try {
        const { id } = req.params;
...
const registerOpenElectiveCourse = async (req, res) => {
    try {
        const { id } = req.params;
        const { _id, department} = req.user;
...
const getRegisteredElectiveCourses = async(req, res)=> {
...
module.exports = { getCourses, registereElectiveCourse, registerOpenElectiveCourse, getRegisteredElectiveCourses }